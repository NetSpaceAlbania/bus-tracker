...
# Default values for bus lines and status
default_bus_line = {0:10, 1:10, 2:10, 3:10}
default_bus_status = 150
default_bus_mode = 5

busStationStatus = []
bus_nr = 4
bus_stop_status = 0   # Status of bus stop

speeds = {'bus':2.25, 'bus2':1.8, 'bus3':2.0, 'bike4':2.5, 'bus5':3.1} 
...
signal_codes = [(530,230),(810,230),(810,570),(530,570)]
signal_timer_codes = [(530,210),(810,210),(810,550),(530,550)]

# Coordinates of stop lines
stop_location = {'right': 590, 'down': 330, 'left': 800, 'up': 535}
default_stop_location = {'right': 580, 'down': 320, 'left': 810, 'up': 545}
...
class TrafficSignal:
    def __init__(self, bus_line, bus_status, bus_mode):
        self.red = red
        self.yellow = yellow
        self.green = green
        self.signalText = ""
...
class Vehicle(pygame.sprite.Sprite):
    ...
    def move(self):
        if(self.direction=='right'):
            if(self.crossed==0 and self.x+self.image.get_rect().width>stop_lines[self.direction]):   # if the image has crossed stop line now
                self.crossed = 1
...
class Main:
    ...
    redSignal = pygame.image.load('images/xxx.png')
    yellowSignal = pygame.image.load('images/xxx.png')
    greenSignal = pygame.image.load('images/xxx.png')
